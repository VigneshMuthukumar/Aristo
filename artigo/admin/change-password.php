...
$sql=mysqli_query($con,"SELECT Password FROM  tblusers where FirstName='$adminid' || EmailId='$adminid'");
...
if (password_verify($password, $dbpassword)) {
 ...
 $con=mysqli_query($con,"update tblusers set Password='$newhashedpass' where FirstName='$adminid'");
